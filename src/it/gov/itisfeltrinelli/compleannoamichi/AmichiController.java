...
public class AmichiController {
    ...
    void onCancella(ActionEvent event) {
    	aml.deleteAmico(new Amico(txtNome.getText(), txtCognome.getText(), null));
    }
    ...
    void onSelection(MouseEvent event) {
    	Amico selezionato = lwAmici.getSelectionModel().getSelectedItem();
    	txtNome.setText(selezionato.getNome());
    	txtCognome.setText(selezionato.getCognome());
    }
