...
public class Amico implements Comparable<Amico> {
	...
	public int compareTo(Amico arg0) {
		 ...
		 * this.dataDiNascita.getMonthValue(), this.dataDiNascita.getDayOfMonth());
		 * return thisDate.compareTo(arg0.getDataDiNascita());
		 */
		// Integer
		// dt1=this.dataDiNascita.getMonthValue()*100+this.dataDiNascita.getDayOfMonth();
		// Integer
		// dt2=arg0.getDataDiNascita().getMonthValue()*100+arg0.getDataDiNascita().getDayOfMonth();
	...
	public boolean equals(Object arg0) {
		return (arg0 != null
				&& (this.cognome.equals(((Amico) arg0).getCognome()) && this.nome.equals(((Amico) arg0).getNome())));
	}
}
